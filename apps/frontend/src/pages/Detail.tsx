...
export function Detail({ listing, search, onBack, onLogo, onReserve, onHosting }: DetailProps) {
  const l = listing;
  const nights = 1;
  ...
  return (
    <div>
      <Header mode="compact" search={search} onSearchPill={onBack} onLogo={onLogo} onHosting={onHosting} />
